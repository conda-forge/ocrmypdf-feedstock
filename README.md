...
Once the `conda-forge` channel has been enabled, `ocrmypdf` can be installed with:

```
conda install ocrmypdf
```

It is possible to list all of the versions of `ocrmypdf` available on your platform with:
